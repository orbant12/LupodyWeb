       ...
       <nav className="nav container">
          <div className="nav__data">
             <a href="/landing" className="nav__logo">
                <i className="ri-planet-line"></i> lupody
             </a>
        ...
        <div className='support-settings' id='support-settings'>
            ...
            <div className='profile-first-row'>
               ...
               <div className='customer-service-contact'>
                    <h4>Contact Us</h4>
                    <h6 style={{marginTop:10}}>clippify.support@gmail.com</h6>
                    <h6 style={{marginTop:10}}>lupody.support@gmail.com</h6>
               </div>

               <div className='policies'>
                    <a href='/policies' className='manage-payment-button'>Wanna Report Something ?</a>
               </div>
